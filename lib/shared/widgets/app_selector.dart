...
Future<DateTime?> showDurationSelector(BuildContext context, String appLabel) async {
  final choice = await showModalBottomSheet<DurationChoice>(
    context: context,
    backgroundColor: AppColors.bg,
    shape: const RoundedRectangleBorder(
      borderRadius: BorderRadius.vertical(top: Radius.circular(AppRadius.xl)),
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Text('Block $appLabel',
                style: const TextStyle(fontSize: 17, fontWeight: FontWeight.w600, color: AppColors.ink)),
          ),
          const Padding(
            padding: EdgeInsets.symmetric(horizontal: 20),
            child: Text('Access is restored automatically when the block ends.',
